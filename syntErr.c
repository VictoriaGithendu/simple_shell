...
/**
 * repeated_char - function that checks for repetiotion of characters
...
/**
 * error_sep_op - function to find syntax errors
 * @input: string input to be checked
 * @i: counter
 * @last: previous read character
...
/**
 * first_char - function that points to the first character in a string
 * @input: pointer to string input
 * @i: index counter
...
/**
 * print_syntax_error - function that outputs an error if found
 * @datash: stucture for data containing argument variables
 * @input:  pointer to string input
 * @i: pointer to error index
...
/**
 * check_syntax_error - function that checks and prints out syntax error msg
 * @datash: stucture for data containing argument variables
 * @input: pointer to string input
