...
/**
 * cd_dot - function that edits the parent directory
...
/**
 * cd_to - function to change to user given directory
 * @datash: stucture for data containing argument variables
 * Return: nothing
 */
...
/**
 * cd_previous - function that changes to previous directory
 * @datash: stucture for data containing argument variables
 * Return: nothing
 */
...
/**
 * cd_to_home - function to move to home directory
 * @datash: stucture for data containing argument variables
 * Return: nothing
 */
